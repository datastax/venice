...
public class AdminSparkServer extends AbstractVeniceService {
  ...
  public boolean startInner() throws Exception {
    ...
    ControllerRoutes controllerRoutes = new ControllerRoutes(sslEnabled, accessController, authenticationService, authorizerService);
    StoresRoutes storesRoutes = new StoresRoutes(sslEnabled, accessController, authenticationService, authorizerService);
    JobRoutes jobRoutes = new JobRoutes(sslEnabled, accessController, authenticationService, authorizerService);
    SkipAdminRoute skipAdminRoute = new SkipAdminRoute(sslEnabled, accessController, authenticationService, authorizerService);
    CreateVersion createVersion = new CreateVersion(
        sslEnabled,
        accessController,
        this.checkReadMethodForKafka,
        disableParentRequestTopicForStreamPushes,
        authenticationService, authorizerService);
    CreateStore createStoreRoute = new CreateStore(sslEnabled, accessController, authenticationService, authorizerService);
    NodesAndReplicas nodesAndReplicas = new NodesAndReplicas(sslEnabled, accessController, authenticationService, authorizerService);
    SchemaRoutes schemaRoutes = new SchemaRoutes(sslEnabled, accessController, authenticationService, authorizerService);
    ...
    MigrationRoutes migrationRoutes = new MigrationRoutes(sslEnabled, accessController, authenticationService, authorizerService);
    VersionRoute versionRoute = new VersionRoute(sslEnabled, accessController, authenticationService, authorizerService);
    ClusterRoutes clusterRoutes = new ClusterRoutes(sslEnabled, accessController, authenticationService, authorizerService);
    NewClusterBuildOutRoutes newClusterBuildOutRoutes = new NewClusterBuildOutRoutes(sslEnabled, accessController, authenticationService, authorizerService);
    DataRecoveryRoutes dataRecoveryRoutes = new DataRecoveryRoutes(sslEnabled, accessController, authenticationService, authorizerService);
    AdminTopicMetadataRoutes adminTopicMetadataRoutes = new AdminTopicMetadataRoutes(sslEnabled, accessController, authenticationService, authorizerService);
    StoragePersonaRoutes storagePersonaRoutes = new StoragePersonaRoutes(sslEnabled, accessController, authenticationService, authorizerService);
